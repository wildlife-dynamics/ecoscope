...
def get_patrol_observations_from_smart(
    ...
    ca_uuid: Annotated[
        str, Field(description="Conservation Area UUID", title="Conservation Area UUID")
    ],
    language_uuid: Annotated[
        str, Field(description="Language UUID", title="Language UUID")
    ],
    patrol_mandate: Annotated[
        str | SkipJsonSchema[None],
        AdvancedField(
            default=None, description="Patrol Mandate", title="Patrol Mandate"
        ),
    ] = None,
    patrol_transport: Annotated[
        str | SkipJsonSchema[None],
        AdvancedField(
            default=None, description="Patrol Transport", title="Patrol Transport"
        ),
    ] = None,
