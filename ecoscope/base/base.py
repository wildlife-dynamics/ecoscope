...
class Trajectory(StraighttrackMixin):
    ...
    def calculate_proximity(self, proximity_profile):
        """
        ...
        def analysis(traj):
            for sf in proximity_profile.spatial_features:
                ...
                start_fix = gpd.GeoSeries([shapely.geometry.Point(g.coords[0]) for g in traj.geometry])
        ...
        self._gdf.groupby("groupby_col")[self._gdf.columns].apply(analysis, include_groups=False)
